...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Menu/</span> Ubah Data</h4>
                        ...
                        <form action="{{ route('menu.update', $menu->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama"
                                        value="{{ $menu->nama }}" placeholder="Masukkan Nama Menu"
                                        aria-describedby="nama2" />
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" id="deskripsi" name="deskripsi" value="{{ $menu->deskripsi }}"
                                        class="form-control" placeholder="Masukkan Deskripsi Menu"
                                        aria-describedby="deskripsi2" />
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="number" id="harga" name="harga" value="{{ $menu->harga }}"
                                        class="form-control" placeholder="Masukkan Harga Menu" aria-describedby="harga2" />
                                </div>
                            </div>
                            <div class="mb-3">
