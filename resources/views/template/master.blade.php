          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="/pesanan/" class="menu-link">
                <i class="menu-icon tf-icons bx bxs-bell-ring" style="color: #0C6638"></i>
            ...
            <li class="menu-item">
              <a href="/riwayat/" class="menu-link">
                <i class="menu-icon tf-icons bx bx-history" style="color: #0C6638"></i>
            ...
            <li class="menu-item">
              <a href="/menu/" class="menu-link">
                <i class="menu-icon tf-icons bx bx-food-menu" style="color: #0C6638"></i>
            ...
            <li class="menu-item">
              <a href="/user" class="menu-link">
                <i class="menu-icon tf-icons bx bx-user" style="color: #0C6638"></i>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                <li class="nav-item">
                    <span class="nav-link fw-bold">
                        <i class="menu-icon tf-icons bx bx-user" style="color: #00A54F"></i>
                        {{ Auth::user()->name }}
                    </span>
                </li>
                <li class="nav-item">
